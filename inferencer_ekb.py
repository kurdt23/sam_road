...
from dataset import ekb_data_partition, ekb_data_partition_2048, ekb_data_partition_400, ekb2_data_partition_2048, ekb2_data_partition_400
from dataset import ekb_data_partition_2048_x2, ekb_data_partition_400_x2, ekb_data_partition_2048_x4, ekb_data_partition_400_x4
...
if __name__ == "__main__":
    ...
    #ekb
        ...
        rgb_pattern = './ekb/{}.png'
        # gt_graph_pattern = './ekb/{}.png'
        # gt_graph_pattern = './ekb/RGB_1.0_meter/{}__gt_graph.p'
        
        
    elif config.DATASET == 'ekb2048':
        _, _, test_img_indices = ekb_data_partition_2048()
        rgb_pattern = './ekb/2048/X1/{}.png'
        # gt_graph_pattern = './ekb/{}.png'
        # gt_graph_pattern = './ekb/RGB_1.0_meter/{}__gt_graph.p'
    
    elif config.DATASET == 'ekb400':
        _, _, test_img_indices = ekb_data_partition_400()
        # rg2_x1_117.png
        rgb_pattern = './ekb/400/X1/rg2_x1_{}.png'  
        # gt_graph_pattern = './ekb/{}.png'
        # gt_graph_pattern = './ekb/RGB_1.0_meter/{}__gt_graph.p'
        
        
    elif config.DATASET == 'ekb2048_x2':
        _, _, test_img_indices = ekb_data_partition_2048_x2()
        rgb_pattern = './ekb/2048/X2/rg2_x2_{}.png'
        # gt_graph_pattern = './ekb/{}.png'
        # gt_graph_pattern = './ekb/RGB_1.0_meter/{}__gt_graph.p'
        
    
    elif config.DATASET == 'ekb400_x2':
        _, _, test_img_indices = ekb_data_partition_400_x2()
        # rg2_x1_117.png
        rgb_pattern = './ekb/400/X2/rg2_x2_{}.png'  
        # gt_graph_pattern = './ekb/{}.png'
        # gt_graph_pattern = './ekb/RGB_1.0_meter/{}__gt_graph.p'
        
        
    elif config.DATASET == 'ekb2048_x4':
        _, _, test_img_indices = ekb_data_partition_2048_x4()
        rgb_pattern = './ekb/2048/X4/rg2_x4_{}.png'
        # gt_graph_pattern = './ekb/{}.png'
        # gt_graph_pattern = './ekb/RGB_1.0_meter/{}__gt_graph.p'
        
    
    elif config.DATASET == 'ekb400_x4':
        _, _, test_img_indices = ekb_data_partition_400_x4()
        # rg2_x1_117.png
        rgb_pattern = './ekb/400/X4/rg2_x4_{}.png'  
        # gt_graph_pattern = './ekb/{}.png'
        # gt_graph_pattern = './ekb/RGB_1.0_meter/{}__gt_graph.p
    ...
    #ekb2    
    elif config.DATASET == '2ekb2048':
        _, _, test_img_indices = ekb2_data_partition_2048()
        rgb_pattern = './ekb/ekb2/2048/rg1_x1_{}.png'
        # gt_graph_pattern = './ekb/{}.png'
        # gt_graph_pattern = './ekb/RGB_1.0_meter/{}__gt_graph.p'
        
    
    elif config.DATASET == '2ekb400':
        _, _, test_img_indices = ekb2_data_partition_400()
        # rg1_x1_117.png
        rgb_pattern = './ekb/ekb2/400/rg1_x1_{}.png'  
        # gt_graph_pattern = './ekb/{}.png'
        # gt_graph_pattern = './ekb/RGB_1.0_meter/{}__gt_graph.p'
    
    print(f'##### DATASET: {config.DATASET} #####')
    output_dir_prefix = f'./save/infer_{config.DATASET}_'
    if args.output_dir:
...
# CHANGES  
            ...
            # Ensure the patch coordinates are valid and within bounds of the fused masks
            if y0 >= fused_keypoint_mask.shape[0] or x0 >= fused_keypoint_mask.shape[1]:
                continue  # Skip this patch, it's outside the image boundaries
        
            if y1 > fused_keypoint_mask.shape[0]:
                # Adjust patch size for y-dimension
            ...
            if x1 > fused_keypoint_mask.shape[1]:
                # Adjust patch size for x-dimension
            ...
            # Skip patches that become zero-sized after adjustments
